...
result_dir = './results-1b/' # directory where the results from the training are saved
...
Loss_list = {1e-4:[],1e-3:[],1e-2:[]}
Accuracy_list = {1e-4:[],1e-3:[],1e-2:[]}
...
#plot train accuracy for AdamOptimizer
# fig,ax = plt.subplots()
# fig.suptitle('Accuracy with different LR AdamOptimizer',fontsize = 18)
# ax.plot(range(len(Accuracy_list[1e-4])),Accuracy_list[1e-4],'k',label = 'Train Accuracy with LR,1e-4 ')
# ax.plot(range(len(Accuracy_list[1e-3])),Accuracy_list[1e-3],'b',label = 'Train Accuracy with LR,1e-3 ')
# ax.plot(range(len(Accuracy_list[1e-2])),Accuracy_list[1e-2],'r',label = 'Train Accuracy with LR,1e-2 ')
# ax.set(xlabel='Iteration', ylabel='Accuracy')
# ax.legend(loc = 'upper left',shadow = True)
# plt.show()
# fig.savefig('Accuracy_AdamOptimizer.png')

#plot loss for AdamOptimizer
# fig,bx = plt.subplots()
# fig.suptitle('Loss with different LR AdamOptimizer',fontsize = 18)
# bx.plot(range(len(Loss_list[1e-4])),Loss_list[1e-4],'k',label = 'Train Loss with LR,1e-4 ')
# bx.plot(range(len(Loss_list[1e-3])),Loss_list[1e-3],'b',label = 'Train Loss with LR,1e-3 ')
# bx.plot(range(len(Loss_list[1e-2])),Loss_list[1e-2],'r',label = 'Train Loss with LR,1e-2 ')
# bx.set(xlabel='Iteration', ylabel='Loss')
# bx.legend(loc = 'lower left',shadow = True)
# plt.show()
# fig.savefig('Loss_AdamOptimizer.png')

#plot train accuracy for AdagradOptimizer
# fig,ax = plt.subplots()
...
#plot loss for AdagradOptimizer
# fig,bx = plt.subplots()
...
#plot train accuracy for MomentumOptimizer
fig,ax = plt.subplots()
fig.suptitle('Accuracy with different LR MomentumOptimizer',fontsize = 18)
ax.plot(range(len(Accuracy_list[1e-4])),Accuracy_list[1e-4],'k',label = 'Train Accuracy with LR,1e-4 ')
ax.plot(range(len(Accuracy_list[1e-3])),Accuracy_list[1e-3],'b',label = 'Train Accuracy with LR,1e-3 ')
ax.plot(range(len(Accuracy_list[1e-2])),Accuracy_list[1e-2],'r',label = 'Train Accuracy with LR,1e-2 ')
ax.set(xlabel='Iteration', ylabel='Accuracy')
ax.legend(loc = 'upper left',shadow = True)
plt.show()
fig.savefig('Accuracy_MomentumOptimizer.png')

#plot loss for MomentumOptimizer
fig,bx = plt.subplots()
fig.suptitle('Loss with different LR MomentumOptimizer',fontsize = 18)
bx.plot(range(len(Loss_list[1e-4])),Loss_list[1e-4],'k',label = 'Train Loss with LR,1e-4 ')
bx.plot(range(len(Loss_list[1e-3])),Loss_list[1e-3],'b',label = 'Train Loss with LR,1e-3 ')
bx.plot(range(len(Loss_list[1e-2])),Loss_list[1e-2],'r',label = 'Train Loss with LR,1e-2 ')
bx.set(xlabel='Iteration', ylabel='Loss')
bx.legend(loc = 'lower left',shadow = True)
plt.show()
fig.savefig('Loss_MomentumOptimizer.png')